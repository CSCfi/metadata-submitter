...
class BaseObjectOperator(ABC):
    ...
    a project and that are clustered by submission.
    ...
    async def _remove_object_from_db(self, schema_type: str, accession_id: str) -> bool:
        ...
        We can omit raising error for XMLObjectOperator if id is not
        ...
        try:
            ...
            delete_success: bool = await self.db_service.delete(schema_type, accession_id)
        except (ConnectionFailure, OperationFailure) as error:
