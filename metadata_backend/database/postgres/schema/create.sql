...
CREATE TABLE submissions (
	...
	CONSTRAINT ck_workflow CHECK (workflow IN ('FEGA', 'Bigpicture', 'SDSX'))
)
...
CREATE TABLE files (
	...
	unencrypted_checksum_type VARCHAR(6),
	encrypted_checksum VARCHAR(128),
	encrypted_checksum_type VARCHAR(6),
	...
	CONSTRAINT ck_unencrypted_checksum_type CHECK (unencrypted_checksum_type IN ('md5', 'sha256')),
	CONSTRAINT ck_encrypted_checksum_type CHECK (encrypted_checksum_type IN ('md5', 'sha256')),
