...
class TestTaxonomySearch:
    """Test taxonomy name search."""

    async def test_taxonomy_search_by_name_works(self, client_logged_in):
    ...
    async def test_taxonomy_search_by_id_works(self, client_logged_in):
    ...
    async def test_taxonomy_limit_search_results_works(self, client_logged_in):
    ...
    async def test_taxonomy_invalid_query_fails(self, client_logged_in):
    ...
    async def test_taxonomy_invalid_result_count_fails(self, client_logged_in):
