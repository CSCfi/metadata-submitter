...
async def test_sd_submission(client_logged_in, submission_factory, project_id):
...
async def test_sd_bucket(client_logged_in, submission_factory):
...
async def test_sd_rems(client_logged_in, submission_factory):
